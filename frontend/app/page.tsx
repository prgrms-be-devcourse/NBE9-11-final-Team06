...
const INITIAL_SEOUL_AREAS: SeoulAreaWithCrowd[] = SEOUL_AREAS.map((area) => ({
  ...area,
  populationMin: null,
  populationMax: null,
}))
...
async function getSeoulAreasWithCrowd(): Promise<SeoulAreaWithCrowd[]> {  return Promise.all(
...
export default function HomePage() {
  const [seoulAreas, setSeoulAreas] =
      useState<SeoulAreaWithCrowd[]>(INITIAL_SEOUL_AREAS)

  useEffect(() => {
    void getSeoulAreasWithCrowd().then(setSeoulAreas)
  }, [])
